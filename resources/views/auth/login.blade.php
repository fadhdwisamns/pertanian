...
<head>
    ...
    <style>
        ...
        /* CSS BARU UNTUK MENGATUR UKURAN LOGO */
        .login-logo {
            width: 180px; /* Anda bisa sesuaikan ukurannya di sini */
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center text-white p-5 info-panel">
                                <div class="text-center">
                                    <div class="mb-4">
                                        {{-- Tambahkan class="login-logo" di sini --}}
                                        <img src="{{ asset('images/logo-pertanian.svg') }}" alt="Logo Pertanian" class="login-logo">
                                    </div>
                                    {{-- JUDUL SISTEM --}}
